...
// Three syncs run sequentially in one request. Amplitude alone now pulls a
// full year of history, so raise this to Vercel's Hobby-plan max (300s) -
// 60s was cutting it too close as the syncs grew.
